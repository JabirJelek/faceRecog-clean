...
$Config = @{
    # Worker script path
    WorkerScript = "D:\RaihanFarid\Dokumen\faceRecog\ProjectKnowledgeBase\active\projects\maskRecog\script-run\1_magick\maskDetect.ps1"
    
    # Schedule (24-hour format)
    StartTime = "08:50"    # 3:08 PM
    EndTime = "11:08"      # 3:15 PM
    ...
    PythonScriptPath = "D:\RaihanFarid\Dokumen\faceRecog\ProjectKnowledgeBase\active\patterns\algorithm\entry_multi-USED-Magick.py"
