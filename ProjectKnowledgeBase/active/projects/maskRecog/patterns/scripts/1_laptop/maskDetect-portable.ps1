...
function Initialize-ProjectPortablePaths {
    ...
    $global:VENV_ROOT = Split-Path $projectRoot -Parent | Split-Path -Parent | Split-Path -Parent | Split-Path -Parent
    ...
    $PYTHON_SCRIPT = Join-Path $ProjectRoot "patterns\algorithm\entry_multi-USED-Laptop.py"
