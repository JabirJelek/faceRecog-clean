...
class UnknownFaceEnroller:
    ...
    def update_unknown_faces(self, results, frame_count):
        ...
        for result in results:
            if (result['identity'] is None or result['identity'] == 'Unknown') and \
               result['detection_confidence'] > self.config.get('auto_enroll_min_confidence', 0.6):
                ...
                if face_id in self.unknown_faces:
                    ...
                    track['embeddings'].append(result['embedding'])
                    track['bbox'] = result['bbox']  # Update position
    ...
    def _generate_face_id(self, bbox):
        """Simple face ID based on position"""
        x1, y1, x2, y2 = bbox
        center_x, center_y = (x1 + x2) // 2, (y1 + y2) // 2
        return f"unknown_{center_x}_{center_y}"
    ...
    def check_and_enroll_unknown_faces(self, frame_count, original_frame=None):
        """Check if any unknown faces should be enrolled"""
        if not self.config.get('enable_auto_enrollment', True):
            return 0
...
CONFIG = {
    'detection_model_path': r'/home/scma/Documents/raihan/Computer-Vision-CV/3.1_FaceRecog/yolov11n-face.pt',
    'mask_model_path': r'/home/scma/Documents/raihan/Computer-Vision-CV/3.1_FaceRecog/run_py/mask_detector112.onnx',  
    'embeddings_db_path': r'/home/scma/Documents/raihan/Computer-Vision-CV/3.1_FaceRecog/person_folder_3.json',
