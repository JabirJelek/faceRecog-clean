...
# ... (Rest of the code remains the same - DisplayResizer, RealTimeProcessor, SimpleFaceTracker, FairnessController, and main functions)
...
# ENHANCED CONFIG WITH VOYAGER SETTINGS
ROBUST_CONFIG = {
    **CONFIG,
    ...
    # Voyager similarity configuration
    'similarity_method': 'voyager',
}
...
def main_priority_optimized():
    ...
    processor = RealTimeProcessor(face_system=face_system)
