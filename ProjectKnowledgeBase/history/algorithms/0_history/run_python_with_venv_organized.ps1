...
# ========== CONFIGURATION ==========
$VENV_ROOT = "A:\SCMA\3-APD\fromAraya\faceRecog"
$PYTHON_SCRIPT = "A:\SCMA\3-APD\fromAraya\Computer-Vision-CV\3.1_FaceRecog\run_py\modular\entry_multi-USED-Laptop.py"
$ARG1 = "--multi-source"

# Base path for all runs (outside virtual environment)
$RUNS_BASE_PATH = "A:\SCMA\3-APD\fromAraya\faceRecog-runs"
# ===================================
