...
from face_recog_modular1 import create_system, ConfigManager
from face_recog_modular1.streaming.multi_realtime import MultiSourceRealTimeProcessor
import time
import os
    ...
    return {
        ...
        'tracking': {
            ...
            'progressive_mask': {          
                ...
                'mask_consistency_threshold': 0.55,
                
                # Require higher stability before committing
                'min_stability_to_commit': 0.55,
                ...
                'weight_increase_high_conf': 0.8,
                'weight_decrease_low_conf': 0.7,
                'weight_increase_opposite': 0.2,
            ...
            'min_violation_frames': 2,           # DECREASED from 35 - quicker to detect violations
        ...
        'violation_verification': {
            ...
            'confidence_threshold': 0.4,         # DECREASED from 0.85 - more sensitive
...
def get_advanced_sources_config():
    ...
    return {
        ...
        '2': {
            'url': 'rtsp://admin:admin888@192.168.110.36:554/Streaming/Channels/501',
