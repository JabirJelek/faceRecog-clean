...
from .recognition import FaceRecognitionSystem, RobustFaceRecognitionSystem
from .streaming import RealTimeProcessor, StreamManager, RealTimeProcessorHeadless
from .alerting import AlertManager, DurationAwareAlertManager, VoiceInterface
...
def create_system(config: dict, system_type: str = "robust"):
    ...
    if system_type == "robust":
        ...
        from .recognition import VoyagerFaceRecognitionSystem
