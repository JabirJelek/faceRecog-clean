...
$ScriptPath = "C:\raihan\dokumen\project\Computer-Vision-CV\run_python_with_venv_organized-TowerCPU.ps1"
$WorkingDirectory = "C:\raihan\dokumen\project\DeteksiMasker"
$LogFilePath = "C:\raihan\dokumen\project\DeteksiMasker\TaskScheduler_Setup.log"
# ===================================
