...
class TrackingManager:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.violation_verification_enabled = tracking_config.get('violation_verification_enabled', False)
        self.min_violation_frames = tracking_config.get('min_violation_frames', 0)
        self.min_violation_duration = tracking_config.get('min_violation_duration', 0.0)  # seconds
