...
# ==============================================
# REFEFENCES
# REASON: This file was the first version of the utilization of monitor. This is stable in the time it was created.
# LEARNINGS: Utilization of monitoring and 
...
# Please check and udate path below
    ...
    StartTime = "08:16"    # 3:08 PM
    EndTime = "11:35"      # 3:15 PM
    ...
    # PID tracking
    PIDFilePath = "D:\RaihanFarid\Dokumen\faceRecog\ProjectKnowledgeBase\active\logs-running\magick\monitor_pid.json"
    MaxPIDFileAgeMinutes = 120  # Clean up old PID files
    
    # Logging
    LogFile = "D:\RaihanFarid\Dokumen\faceRecog\ProjectKnowledgeBase\active\logs-running\magick\monitor.log"
