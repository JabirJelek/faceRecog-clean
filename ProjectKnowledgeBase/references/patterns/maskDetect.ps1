...
# ==============================================
# REFERENCES
# REASON: This file was stable script that is utilized to run our python program
# LEARNINGS: This script was utilized to create each folder accordingly, by checknig the validity of the folder location
# REFERENCE: This script was utilized in the monitor script.
# ==============================================
