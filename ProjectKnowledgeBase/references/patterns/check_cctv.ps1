...
# ==============================================
# DEPRECATED
# REASON: Because The script no longer utilized. The script utilized to check the cctv connection from ip address
# LEARNINGS: We know that there are script that can be utilized to check cctv connection
# REFERENCE: Simply utilized angryipscanner to check each ip connection.
# ==============================================
