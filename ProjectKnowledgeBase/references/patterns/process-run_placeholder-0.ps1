...
# ==============================================
# ALTERNATIVE 
# REASON: This file was actually utilized as placeholder if we want to utilize the script. We have several pattern design that run in different machine
# LEARNINGS: Modularity of each design can be achieved simply by folderizing each design into each utilization
# REFERENCE: Simply change the folder location of sevearl components below.
# ==============================================
...
$PYTHON_SCRIPT = "D:\RaihanFarid\Dokumen\faceRecog\ProjectKnowledgeBase\references\algorithms\C_threading.py"
...
$RUNS_BASE_PATH = "D:\RaihanFarid\Dokumen\faceRecog\ProjectKnowledgeBase\history\logs\process-run"
# ===================================
...
$RUN_FOLDER_NAME = "process_run_placeholder_$timestamp"
