...
# ==============================================
# REFERENCED 
# REASON: This file can be utilized as references, because we are utilizing much more modular and scalable program, While utilizing this program is very basic and fast to test.
# LEARNINGS: Selective frame processor is a method that choose frame selectively and process such frame for next process
# REFERENCE: If we want quick implementation of faces detection with yolo model.
# ==============================================
