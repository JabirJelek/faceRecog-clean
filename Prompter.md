...
Utilize references below.

### Instruction

disable completely smtp, no need for fallback method

### Result output of the codebase

The codebase output that credential is
...
New-Item -ItemType Directory -Path $logDir -Force | Out-Null
    ...
    Write-Log "Monitor Version: 2.0 (Stable)" -Level "INFO"
